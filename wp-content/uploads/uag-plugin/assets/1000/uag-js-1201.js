...
window.open( request_url, target );
			...
			jQuery(document).ready(function () {
				let scope = jQuery(".wp-block-uagb-image-gallery.uagb-block-620a7d63");
				if ( scope.length ) { 
